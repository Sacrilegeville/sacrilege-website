 export default function SandBaggySweatsPage() {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="max-w-7xl mx-auto px-8 py-32">
        ...
        <div className="grid md:grid-cols-2 gap-24 items-start">
          ...
          <div>
            ...
            <img
              src="/images/Sand baggy.png"
              alt="Sand Baggy Sweats"
      ...
      <section className="max-w-7xl mx-auto px-8 pb-40">
        ...
        <div className="mt-20">
          ...
          <img
            src="/images/sand on body.PNG"
            alt="Sand Baggy Sweats Campaign"
            className="w-full object-cover"
          />
      ...
      <section className="max-w-3xl mx-auto py-40 px-8 text-center border-t border-white/10">
        ...
        <p className="max-w-xl mx-auto mt-10 text-gray-500 leading-8">
          The Sand Thermal was designed alongside these sweats to create a
