export default function BlackBaggySweatsPage() {
  return (
      ...
      <section className="max-w-7xl mx-auto px-8 py-32">
        ...
        <div className="grid md:grid-cols-2 gap-24 items-start">
          ...
          <div>
            ...
            <img
              src="/images/black baggy.png"
              alt="Black Baggy Sweats"
        ...
        <div>
           ...
           <h3 className="uppercase tracking-[0.35em] text-sm">
  Size
</h3>
  ...
  <button className="border border-white px-6 py-4 hover:bg-white hover:text-black transition-all duration-300">
    XL / 36
            ...
            <button className="w-full mt-8 md:mt-14 bg-white text-black py-5 uppercase tracking-[0.4em] hover:bg-gray-200 transition-all duration-300 relative z-20">
              ADD TO BAG
            </button>
      ...
      <section className="max-w-7xl mx-auto px-8 pb-40">
        ...
        <div className="border-t border-white/10 pt-20">
          ...
          <p className="text-gray-400 max-w-2xl mt-8 leading-8">
            Built with an oversized silhouette and heavyweight cotton
            construction. Finished with distressed detailing for a worn-in
            look while maintaining premium structure.
          </p>
...
/>
      ...
      <section className="max-w-3xl mx-auto py-40 px-8 text-center border-t border-white/10">
        ...
        <p className="max-w-xl mx-auto mt-10 text-gray-500 leading-8">
          The Black Thermal was designed alongside these sweats to create a
      ...
      <section className="border-t border-white/10 py-40">
        ...
        <div className="max-w-3xl mx-auto px-8 text-center">
          ...
          <h2 className="text-5xl md:text-6xl font-black uppercase mt-8">
            JOIN THE MAILING LIST
          </h2>

          <p className="text-gray-400 max-w-xl mx-auto mt-8 leading-8">
            Be the first to know about future drops, exclusive releases,
            and limited restocks.
          </p>

          <div className="flex flex-col md:flex-row gap-4 mt-14 max-w-xl mx-auto">

            <input
              type="email"
              placeholder="EMAIL ADDRESS"
              className="flex-1 bg-transparent border border-white/20 px-6 py-5 uppercase tracking-[0.2em] outline-none focus:border-white"
            />

            <button className="bg-white text-black px-10 py-5 uppercase tracking-[0.35em] hover:bg-gray-200 transition">
              JOIN
            </button>
