export default function WhiteBaggySweatsPage() {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="max-w-7xl mx-auto px-8 pb-40">
        ...
        <div className="border-t border-white/10 pt-20">
          ...
          <p className="text-gray-400 max-w-2xl mt-8 leading-8">
            ...
            Every piece is finished with distressed detailing to create a
            worn-in feel from day one.
          </p>
        ...
        <div className="mt-20">
          ...
          <img
            ...
            alt="White Baggy Sweats Campaign"
            className="w-full object-cover"
          />
      ...
      <section className="max-w-3xl mx-auto py-40 px-8 text-center border-t border-white/10">
        ...
        <p className="max-w-xl mx-auto mt-10 text-gray-500 leading-8">
          The White Thermal was designed alongside these sweats for a complete
          oversized uniform. Built from the same premium heavyweight cotton.
        </p>
